        ...
        @if (Route::has('login'))
                {{-- <div class="top-right links"> --}}
                    @auth
                        ...
                        <li class="nav-item"><a class="btn btn-primary btn-sm"  href="{{ url('main') }}"><i class="fas fa-user-cog"></i> Mi cuenta</a></li>
                    @else
                ...
                <div class="card-body" id="tablas">
                  <table id="listConvocatorias" class="table table-bordered table-hover table-striped">
                     ...
                     <tr>
                      ...
                      <td ><strong>Oficina:</strong> {{$plazas[$i]->cas_pue_oficina}}<br><strong> Perfil:</strong>{{$plazas[$i]->cas_pue_puesto}}<br><strong>Remuneración: </strong>S/.{{$plazas[$i]->cas_pue_remuneracion}}.00 <br><strong>Cantidad requerida:</strong> {{$plazas[$i]->cas_pue_cantidad_plazas}}<br></td>
