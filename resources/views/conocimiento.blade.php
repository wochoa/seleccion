...
<form id="form_cursos_especializacion"  method="post" action="{{route('formconcimiento')}}" accept-charset="UTF-8" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">  
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <select class="form-control form-control-sm" id="idperfiledet" name="idperfiledet" required>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <span style="color:red; font-size: 16px; vertical-align: middle;">(*)</span>
                    <select class="form-control form-control-sm" id="temas" name="temas" required>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <span style="color:red; font-size: 16px; vertical-align: middle;">(*)</span>
                    <input type="text" class="form-control form-control-sm" name="pcesCentroEstudios" maxlength="80" id="pcesCentroEstudios" autocomplete="off" required>
                </div>
            </div>
    ...
    <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <span style="color:red; font-size: 16px; vertical-align: middle;">(*)</span>
                    <input type="date" class="form-control form-control-sm" id="pcesFechaInicio" name="pcesFechaInicio" required>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <span style="color:red; font-size: 16px; vertical-align: middle;">(*)</span>
                    <input type="date" class="form-control form-control-sm" id="pcesFechaFin" name="pcesFechaFin" required>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="">Duración (N° Horas)</label>
                    <span style="color:red; font-size: 16px; vertical-align: middle;">(*)</span>
                    <input type="number" class="form-control form-control-sm" id="pcesDuracion" name="pcesDuracion" maxlength="4" required>
                </div>
            </div>
    ...
    <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="">Tipo Sustento</label>
                    <span style="color:red; font-size: 16px; vertical-align: middle;">(*)</span>
                    <select class="form-control form-control-sm" id="pcesTipoConstancia" name="pcesTipoConstancia" required>
                      <option value="">[Seleccionar]</option><option value="Certificado">Certificado</option><option value="Constancia">Constancia</option><option value="Diploma">Diplomado de acuerdo al servicio</option></select>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <span style="color:red; font-size: 16px; vertical-align: middle;">(*)</span>
                    <input type="file" id="file_ce" name="file_ce" accept="application/pdf" class="btn btn-default" required>
                </div>
            </div>
            <div class="col-sm-5">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-sm table-striped" width="100%">
            ...
            <tbody data-bind="foreach: cursos_especializaciones">
                ...
                <tr>
                  <td>{{$index->centro_estudio}}</td>
                  <td>{{$index->tema}}</td>
                  <td align="center">{{$index->fecha_inicio}}</td>
                  <td align="center">{{$index->fecha_fin}}</td>
                  
                  <td align="center"><a href="#" title="Ver " data-toggle="modal" data-target="#popupveracademica" onclick="cargaregistroformacionacad({{$index->idconocimiento}},1)"><i class="fa fa-eye"></i></a></td>
                  <td align="center"><a href="#" title="Ver " data-toggle="modal" data-target="#popupeditaracademica" onclick="cargaregistroformacionacad({{$index->idconocimiento}},2)"><i class="fa fa-edit"></i></a></td>
                  <td align="center"><a href="/eliminarregsconocimiento/{{$index->idconocimiento}}/{{auth()->user()->id}}/{{Session('idpos')}}" title=""><i class="fa fa-trash"></i></a></td>
                </tr>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form  role="form" method="post" action="{{ route('actualizaconocimiento') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                      ...
                      <select  class="form-control form-control-sm" name="requeridoedit" id="requeridoedit" required>
                ...
                <div class="row">
                  <div class="col-sm-6">
                      ...
                      <input type="date" class="form-control form-control-sm" name="anioini" required id="anioini">
                  </div>
                  <div class="col-sm-6">
                    <label >Fecha de Fin</label>
                      <input type="date" class="form-control form-control-sm" name="aniofin"  required id="aniofin">
                  </div>
                </div>
                <div class="form-group">
                      <label >Duración (N° Horas) </label>
                      <input type="text" class="form-control form-control-sm" name="nhoras"  required  id="nhoras">
                </div>
                <div class="form-group">
                      <label >Tipo Sustento</label>
                      <select class="form-control form-control-sm" id="tiposustento" name="tiposustento" ><option value="">[Seleccionar]</option><option value="Certificado">Certificado</option><option value="Constancia">Constancia</option><option value="Diploma">Diplomado de acuerdo al servicio</option></select>
                </div>
                <div class="form-group">
                      <label >Adjuntar Sustento(Archivo PDF,máximo 4MB)</label>
                      <input type="file" class="form-control form-control-sm" name="fileconoc" id="fileconoc" accept="application/pdf">
            ...
            success: function(data){ 
              ...
              if(data.length){
               ...
               if(data[0].conocimiento!=null){
                  ...
                  {
                    compuesto=compuesto+'<option value="'+objform[i].data_conocimiento+'"> '+objform[i].data_conocimiento+'</option>';
                  }
...
function cargaregistroformacionacad(id,ver)
{
  ...
  var idformacion=id;
        $.ajax({      
            // data: {reg:id},
            url: '/cargaconocimientoleccionada/'+idformacion,
            type: 'get',
            dataType : "json",        
            success: function(data){ 
              ...
              if(data.length){
                  ...
                  if(ver==1)
                  {
                    ...
                    { 
                      ...
                      html=html+'<tr><td><strong>REQUERIDO:</strong></td><td>'+data[i].requerido+'</td></tr><tr><td><strong>TEMA:</strong></td><td>'+data[i].tema+'</td></tr><tr><td><strong>CENTRO DE ESTUDIOS:</strong></td><td>'+data[i].centro_estudio+'</td></tr><tr><td><strong>FECHA INICIO:</strong></td><td>'+data[i].fecha_inicio+'</td></tr><tr><td><strong>FECHA FIN:</strong></td><td>'+data[i].fecha_fin+'</td></tr><tr><td><strong>dURACION HORAS:</strong></td><td>'+data[i].duracion+'</td></tr></tr><tr><td><strong>SUSTENTO:</strong></td><td>'+data[i].tipo_sustento+'</td></tr><tr><td><strong>ARCHIVO CARGADO:</strong></td><td><a href="/storage/'+nuevacadena+'" title="Arhcivo cargado" target="_blank">Archivo</a></td></tr>';
                     }
                    html=html+'</table>'
                  ...
                  if(ver==2){
                    ...
                    $("#idregformacion").val(data[0].idconocimiento);

                    $("#respfile").html(data[0].archivo_concoimiento);    
