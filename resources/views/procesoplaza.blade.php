...
{{--               <div class="kt-portlet__head-toolbar">
              ...
              <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-group">
                          <div class="kt-portlet__head-group">
                            <a href="#" data-ktportlet-tool="toggle" class="btn btn-sm  btn-brand btn-circle" data-toggle="modal" data-target="#modal-default"><i class="la la-plus-circle"></i> Nuevo proceso</a>
            ...
            <div class="card-body p-2" style="font-size: 13.4px"><br>
               <table class="table" id="listaproceso" data-order='[[0, "desc"]]'>
               	<thead>
               		<tr>
               			<th>ID</th><th>Proceso</th><th>Fechas</th><th>Act/Desc</th><th>acciones</th>
               		</tr>
               	</thead>
               	<tbody>
               		...
               		<tr>
               			...
               			<td>
               				@if($procesocas[$i]->cas_proc_sel_estado==1)
               					<a href="/desactivarproceso/{{$procesocas[$i]->id_proc_sel_cas}}" title="El proceso esta activo"><i class="fa fa-toggle-on"></i></a>
               				 @else
               				    <a href="/activarproceso/{{$procesocas[$i]->id_proc_sel_cas}}" title="El proceso esta desactivado"><i class="fa  fa-toggle-off"></i></a>
               				@endif
               				
               			</td>
               			<td nowrap>
               				<a href="#" class="btn btn-info btn-sm"  title="Ver las plazas" onclick="cargar({{$procesocas[$i]->id_proc_sel_cas}},'{{$procesocas[$i]->proc_sel_cas_descripcion}}');"><i class="fa fa-eye"></i></a>
               				<a href="#" class="btn btn-sm bg-warning" title="Editar las plazas" onclick="cargaprocesoeditar({{$procesocas[$i]->id_proc_sel_cas}})" data-toggle="modal" data-target="#editarproceso"><i class="fa fa-edit"></i></a>
               				<a href="/eliminaproceso/{{$procesocas[$i]->id_proc_sel_cas}}" class="btn btn-danger btn-sm" title="Eliminar las plazas"><i class="fa fa-trash"></i></a>
               			</td></tr>
               		@endfor
               	</tbody>
               </table>
        ...
        <div class="col-sm-7" style="display: none;" id="plazasco">
          <div class="kt-portlet">
            ...
            <div class="kt-portlet__head">
              <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title">
                  Listado de plazas para el <span class="kt-badge kt-badge--brand kt-badge--inline kt-badge--pill" id="nompro"></span>
                </h3>
              </div>
              <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-toolbar">
                  <div class="dropdown dropdown-inline">
                    <button type="button" class="btn btn-clean btn-sm " data-toggle="modal" data-target="#nuevaplaza">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body p-0">
        ...
        <form  role="form" method="post" action="{{ route('procesoeditar') }}" >
          @csrf
          <input type="text" class="form-control" name="idproceso" id="idproceso" >
          <div class="form-group">
                <label >Proceso:</label>
                <input type="text" class="form-control" name="procescase" id="procescase" placeholder="Ingrese el proceso" required>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <label >Fecha Fin inscripcion:</label>
                    <input type="date" class="form-control"  name="fechafininsce" id="fechafininsce" required>
                  </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              <label >Fecha Resultados:</label>
                    <input type="date" class="form-control" name="fecharesule" id="fecharesule" required>
                  </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">
              <label >Fecha Final proceso:</label>
                    <input type="date" class="form-control" name="fechafinale" id="fechafinale" required>
                  </div>
          </div>
        </div>
        <div class="modal-footer justify-content-between">
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form  role="form" method="post" action="{{ route('nuevasplazas') }}" accept-charset="UTF-8" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row">
            <div class="col-sm-6" style="border-right: 1px #ccc dashed;">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-sm" name="nuevaoficina" placeholder="Agregar oficina en caso no aperece la selección">
                        </div>          
                        <div class="form-group">
                              <label >Ingresar la plaza:</label>
                              <input type="text" class="form-control form-control-sm" name="plazas"  placeholder="Ingrese el proceso" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                           <div class="col-sm-3">
                              <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-sm" name="numplazas"  value="1" min="1" required>
                              </div>
                           </div>
                           <div class="col-sm-4">
                              <div class="form-group">
                                <label >Remuneración:</label>
                                <input type="number" class="form-control form-control-sm" name="remuneracion" placeholder="Remuneración" min="1" required>
                              </div>
                           </div>
                           <div class="col-sm-5">
                              <div class="form-group">
                                <label >Perfil plaza:</label>
                                <select class="form-control form-control-sm" name="perfilpostulante" id="perfilpostulante" required>
                                </select>
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
                              <label >Experiencia(general/especfica):</label><a href="#" class="float-right" title="Add field" onclick="agregarexperiencia_new()"><i class="fa fa-plus-circle"></i></a>
            ...
            <div class="col-sm-6">
               <div class="form-group">
                      <label >Formación academica,Grado academico y/o nivel estudio:</label><a href="#" class="float-right" title="Add field" onclick="agregarespecialidad_new()"><i class="fa fa-plus-circle"></i></a>
                ...
                <div class="form-group text-danger">
                      <label class="text-danger">Requiere habilidad profesional y certificado :</label>&nbsp;&nbsp;&nbsp;
                ...
                <div class="form-group">
                      <label >Conocimiento básicos pare puesto y/o cargo:</label><a href="#" class="float-right" title="Add field" onclick="agregarconocimiento_new()"><i class="fa fa-plus-circle"></i></a>
          ...
          <div class="row">
            <div class="col-sm-6" style="border-right: 1px #ccc dashed;">
              <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" name="nuevaoficina1" placeholder="Agregar oficina en caso no aperece la selección">
              </div>
              
              <div class="form-group">
                    <label >Ingresar la plaza:</label>
                    <input type="text" class="form-control form-control-sm" name="plazas1" id="plazas1"  placeholder="Ingrese el proceso" required>
              </div>
                <div class="row">
                   <div class="col-sm-3">
                     <div class="form-group">
                      <label >Cantidad de Plaza:</label>
                      <input type="number" class="form-control form-control-sm" name="numplazas1" id="numplazas1"  value="1" min="1" required>
                    </div>
                   </div>
                   <div class="col-sm-4">
                      <div class="form-group">
                        <label >Remuneración:</label>
                        <input type="number" class="form-control form-control-sm" name="remuneracion1" id="remuneracion1" placeholder="Remuneración" min="1" required>
                      </div>
                   </div>
                   <div class="col-sm-5">
                      <div class="form-group">
                        <label >Perfil plaza:</label>
                        <select class="form-control form-control-sm" name="perfilpostulante1" id="perfilpostulante1" required>
                        </select>
                      </div>
                   </div>
                </div>
               <div class="form-group">
                    <label >Experiencia(general/especfica):</label><a href="#" class="float-right" title="Add field" onclick="agregarexperiencia()"><i class="fa fa-plus-circle"></i></a>
            ...
            <div class="col-sm-6">
                      <div class="form-group">
                            <label >Formación academica,Grado academico y/o nivel estudio:</label><a href="#" class="float-right" title="Add field" onclick="agregarespecialidad()"><i class="fa fa-plus-circle"></i></a>
                      ...
                      <div class="form-group text-danger">
                            <label class="text-danger">Requiere habilidad profesional y certificado :</label>&nbsp;&nbsp;&nbsp;
                              ...
                              <input type="radio" name="certificado1" id="certificado11" value="SI" required> SI
                              <span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <div class="form-group">
                            <label >Conocimiento básicos pare puesto y/o cargo:</label><a href="#" class="float-right" title="Add field" onclick="agregarconocimiento()"><i class="fa fa-plus-circle"></i></a>
...
<script>
 ...
 $(".dataTables_filter input").addClass('form-control form-control-sm anchosear');
  ...
  {
    $("#idprocesos").val(id);// en el id para nueva plaza (se tiene que cambiar el de editar las plazas de lo contrario no funcionara)
        ...
        success: function(data){ 
          ...
          if(data.length){
            ...
            $("#plazasingresadas").show();
             var compuesto='<table class="table table-sm table-hover table-bordered"><head><tr><th>N</th><th>PLAZA</th><th>SUELDO</th><th>FORMACION</th><th>EXPERIENCIA</th><th>CONOCIMIENTO</th><th></th></tr></head>';
              ...
              { 
                ...
                if(formacion!=null){form='<i class="fa fa-check-circle"></i>';} else{form='Falta agregar';}
                if(experiencia!=null){exp='<i class="fa fa-check-circle"></i>';} else{exp='Falta agregar';}
                if(conocimiento!=null){cono='<i class="fa fa-check-circle"></i>';} else{cono='Falta agregar';}

                compuesto=compuesto+'<tr><td>'+idp +'</td><td>'+nomplaza +'</td><td>'+sueldo +'</td><td>'+form+'</td><td>'+exp+'</td><td>'+cono+'</td><td nowrap><a href="#" class="btn btn-label-facebook btn-sm" title="Editar plaza" data-toggle="modal" data-target="#editarplaza" onclick="cargaplazaparedit('+idp+')"><i class="flaticon-edit"></i></a> <a href="/eliminarplaza/'+idp+'" class="btn btn-sm btn-danger" title="Eliminar perfil"><i class="flaticon2-trash"></i></a> </td></tr>';
               }
            ...
            $("#plazasco").show();$("#nompro").html(descripcion);$("#plazasingresadas").hide();
          }
          ...
          if(data.length){                  
             ...
             var compuesto='<option value=""> Seleccione...</option>';
              ...
              { 
                ...
                compuesto=compuesto+'<option value="'+data[i].cas_pue_oficina+'"> '+data[i].cas_pue_oficina+'</option>';
               }
  ...
  $.ajax({      
        ...
        success: function(data){ 
          ...
          if(data.length){ 
            ...
            //certificado12
            if(data[0].certificado_habilidad=='SI'){$('#certificado11').prop("checked",true);}
            else{$('#certificado11').prop("checked",false);}      
            ...
            if(data[0].conocimiento!=null){
              ...
              {
                textcono=textcono+'<div class="row"><input type="text" name="field_conocimiento[]" placeholder="P. Ejemplo: Curso o certificado en Gestión presupuestal " class="form-control col-sm-11" value="'+objcono[i].data_conocimiento+'"><a href="#" class="remove_button col-sm-1" title="Remove field" onclick="eliminarconocimiento()"><i class="far fa-times-circle"></i></a></div>';
              }
              x=i;
              $('.conocimiento_wrapper').html(textcono); // Add field html
            }else{$('.conocimiento_wrapper').html('');}    
            ...
            if(data[0].experiencia!=null){
              ...
              {
                textexpe=textexpe+'<div class="row"><input type="text" name="field_experiencia[]" placeholder="P. Ejemplo: Experiencia general Tres(3) años como mínimo en sector publico o privado" class="form-control col-sm-11" value="'+objexpe[i].data_experiencia+'"><a href="#" class="remove_button col-sm-1" title="Remove field" onclick="eliminarconocimiento()"><i class="far fa-times-circle"></i></a></div>';
              }
              x=i;
              $('.experiencia_wrapper').html(textexpe); // Add field html
            }else{$('.experiencia_wrapper').html('');} 
            ...
            if(data[0].formacion!=null){
              ...
              {
                textform=textform+'<div class="row"><input type="text" name="field_especialidad[]" placeholder="P. Ejemplo: Experiencia general Tres(3) años como mínimo en sector publico o privado" class="form-control col-sm-11" value="'+objform[i].data_formacion+'"><a href="#" class="remove_button col-sm-1" title="Remove field" onclick="eliminarconocimiento()"><i class="far fa-times-circle"></i></a></div>';
              }
              x=i;
              $('.especialidad_wrapper').html(textform); // Add field html
            }else{$('.especialidad_wrapper').html('');}
...
// para agregar y eliminar conocimiento
  function agregarconocimiento_new()
    {   var maxField = 10; //Input fields increment limitation field_conocimiento
        ...
        var fieldHTML = '<div class="row"><input type="text" name="field_conocimiento[]" value="" placeholder="P. Ejemplo: Curso o certificado en Gestión presupuestal " class="form-control col-sm-11"><a href="#" class="remove_button col-sm-1" title="Remove field" onclick="eliminarconocimiento_new()"><i class="far fa-times-circle"></i></a></div>'; //New input field html 
        var x = 1; //Initial field counter is 1
            if(x < maxField){ //Check maximum number of input fields
                x++; //Increment field counter
                $(wrapper).append(fieldHTML); // Add field html
...
// para agregar y eliminar conocimiento
  function agregarconocimiento()
    {   var maxField = 10; //Input fields increment limitation field_conocimiento
        ...
        var fieldHTML = '<div class="row"><input type="text" name="field_conocimiento[]" value="" placeholder="P. Ejemplo: Curso o certificado en Gestión presupuestal " class="form-control col-sm-11"><a href="#" class="remove_button col-sm-1" title="Remove field" onclick="eliminarconocimiento()"><i class="far fa-times-circle"></i></a></div>'; //New input field html 
        var x = 1; //Initial field counter is 1
            if(x < maxField){ //Check maximum number of input fields
                x++; //Increment field counter
                $(wrapper).append(fieldHTML); // Add field html
