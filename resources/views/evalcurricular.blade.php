              ...
              <div class="card">
                ...
                <div class="card-body p-0" style="font-size: 13px">
                   @php
                      ...
                      $habilidad_prof=$inscritos[0]->certificado_habilidad;
              ...
              <div class="card collapsed-card">
                ...
                <div class="card-body p-0" style="font-size: 13px">
                  <ul class="nav nav-pills flex-column">
                    ...
                    @endforeach
                    @if($habilidad_prof=='SI')
                    <li class="nav-link text-danger">Requiere Colegiatura</li>
                    <li class="nav-link text-danger">Requiere Habilitacion</li>
                    @endif
          ...
          <div class="col-md-9">
              <div class="card card-dark collapsed-card">
                ...
                <div class="card-body p-0">
                 ...
                 <h3 class="card-title text-info" style="padding-left: 10px;"><strong>Documentos de sustento</strong></h3>
                  <table class="table table-bordered table-sm table-hover table-striped">
                    ...
                    <tbody>
                      ...
                      <tr><td>{{ $docsustento->sustento }}</td><td>{{ date('d/m/Y', strtotime($docsustento->fecha )) }}</td><td><a href="#" data-toggle="modal" data-target="#modalarchivo" onclick="mostrar_archivo('{{Storage::url($docsustento->archivo)}}');"><i class="fa fa-eye"></a></td></tr>
                        @endforeach
                    </tbody>
                  </table>
                  {{-- @php
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body p-1" style="font-size: 12px">
              <form class="form" method="post" action="{{ route('inserevalcurricular') }}">
                @csrf
                ...
                <div class="form-group row">
                  <div class="col-md-8">
                     <table class="table table-bordered table-sm table-hover">
                        ...
                        @foreach($perfil as $idper)
                          ...
                          @endphp
                          <tr>
                            <td>{{ $i }}</td> <td>{{ $idper->nomdet_perfil }}</td><td>{{ $idper->puntuaciones }}</td><td>{{ $idper->puntagemin }}</td><td><input type="number" name="arraypuntages[]" class="form-control form-control-sm" value="0" id="puntages{{$i}}" onchange="puntuacion()" min="{{ $idper->puntagemin }} " max="{{ $idper->puntuaciones}}" step="{{ $idper->puntagemin }}"></td>
                          </tr>
                        @endforeach
                        <tr class="table-active">
                            <td colspan="2"><strong>PUNTAGE</strong></td><td><strong>{{ $pmax }}</strong></td><td><strong>{{ $pmin  }}</strong></td><td><input type="hidden" name="puntage" id="sumpuntage" value="0"></td>
                          </tr>
                        </tbody>
                    </table>
                  </div>
                  <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                          <textarea placeholder="Ingrese su observacion" class="form-control" id="obs" rows="4" name="obs"></textarea>
                        </div>
                    </div>
                  </div>
                </div>
